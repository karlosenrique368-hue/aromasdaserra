...
<section class="section bg-cream-50">
  <div class="max-w-5xl mx-auto px-6 grid md:grid-cols-[1fr,2fr] gap-12 items-start reveal">
    <aside class="md:sticky md:top-28">
      <span class="eyebrow"><?= e(block('a-pousada','essence_eyebrow','Nossa essência')) ?></span>
...
<section class="section bg-cream-100 paper">
  <div class="max-w-6xl mx-auto px-6 reveal">
    <div class="grid md:grid-cols-2 gap-12 items-center">
      <img src="<?= e(repair_image_url(block('a-pousada','adults_image','https://images.unsplash.com/photo-1499678329028-101435549a4e?auto=format&fit=crop&w=1100&q=80'))) ?>" alt="Detalhe da pousada" class="w-full aspect-[4/5] object-cover rounded-md shadow-xl">
      <div>
...
<section class="section bg-cream-50">
  <div class="max-w-6xl mx-auto px-6 reveal-stagger grid md:grid-cols-3 gap-8 text-center">
    <div><i data-lucide="mountain-snow" class="w-9 h-9 mx-auto text-terracota-500"></i><h3 class="font-editorial text-2xl mt-4 text-forest-900"><?= e(block('a-pousada','feature_1_title','Clima serrano')) ?></h3><p class="mt-2 text-ink-700/80"><?= e(block('a-pousada','feature_1_body','Temperaturas amenas e brisa do campo durante todo o ano.')) ?></p></div>
    <div><i data-lucide="users" class="w-9 h-9 mx-auto text-terracota-500"></i><h3 class="font-editorial text-2xl mt-4 text-forest-900"><?= e(block('a-pousada','feature_2_title','Adults only')) ?></h3><p class="mt-2 text-ink-700/80"><?= e(block('a-pousada','feature_2_body','Atmosfera contemplativa, projetada para o descanso profundo.')) ?></p></div>
    <div><i data-lucide="sparkles" class="w-9 h-9 mx-auto text-terracota-500"></i><h3 class="font-editorial text-2xl mt-4 text-forest-900"><?= e(block('a-pousada','feature_3_title','Hospitalidade')) ?></h3><p class="mt-2 text-ink-700/80"><?= e(block('a-pousada','feature_3_body','Atendimento atento e personalizado para cada hóspede.')) ?></p></div>
  </div>
</section>
