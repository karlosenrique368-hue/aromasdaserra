...
<div class="marquee-bar" aria-hidden="true">
  <span>
    <span>Mar Vermelho · AL</span><i data-lucide="leaf" class="w-4 h-4"></i>
    <span>Cozinha Mediterrânea</span><i data-lucide="leaf" class="w-4 h-4"></i>
    <span>Ritual da Fogueira</span><i data-lucide="leaf" class="w-4 h-4"></i>
    <span>Ritual do Chá da Tarde</span><i data-lucide="leaf" class="w-4 h-4"></i>
    <span>Temporada de Fondue</span><i data-lucide="leaf" class="w-4 h-4"></i>
    <span>Suíça Alagoana</span><i data-lucide="leaf" class="w-4 h-4"></i>
  </span>
...
<section class="relative overflow-hidden bg-forest-900 text-cream-100 noise">
  ...
  <div class="relative max-w-6xl mx-auto px-6 py-20 md:py-28 text-center">
    <span class="eyebrow text-gold-500/80">— Reserve sua estadia —</span>
    <h2 class="font-editorial text-4xl md:text-6xl text-cream-50 mt-4 leading-[1.05]">Frio da serra, gastronomia, requinte e <em class="serif-italic text-gold-500">hospitalidade.</em></h2>
    <p class="mt-5 max-w-2xl mx-auto text-cream-100/80 text-lg leading-relaxed">
      Faça sua reserva e venha vivenciar momentos especiais em meio ao silêncio da natureza, acompanhado de uma cozinha mediterrânea cheia de aromas e sabores.
    </p>
...
<footer class="bg-ink-900 text-cream-100/80">
  <div class="max-w-8xl mx-auto px-6 py-16 grid md:grid-cols-4 gap-10">
    <div class="md:col-span-2">
      ...
      <p class="mt-5 text-[15px] leading-relaxed max-w-md">
        Refúgio boutique em <?= e(SITE_LOCATION) ?>, na Suíça Alagoana. Hospedagem exclusiva para adultos, gastronomia mediterrânea e contemplação em meio à serra.
      </p>
  ...
  <div class="border-t border-cream-100/10">
    <div class="max-w-8xl mx-auto px-6 py-5 text-[12px] flex flex-wrap items-center justify-between gap-3">
      ...
      <span class="text-cream-100/50">Suíça Alagoana · Mar Vermelho — AL</span>
    </div>
  </div>
</footer>
